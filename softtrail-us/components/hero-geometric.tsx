    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303]">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <Image src="/softtrail-logo.png" alt="SoftTrail Logo" width={20} height={20} className="rounded-lg" />
            <span className="text-sm text-zinc-300 tracking-wide">{badge}</span>
          </motion.div>
          ...
          <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
            <p className="text-base sm:text-lg md:text-xl text-zinc-300 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
